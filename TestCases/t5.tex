...
\node(n1) at (1.0,-0.5) [rectangle, draw=n1draw, fill=n1fill, text=n1text] {};

\definecolor{n2fill}{RGB}{255,204,0}
\definecolor{n2text}{RGB}{0,0,0}
\definecolor{n2draw}{RGB}{0,0,0}
\node(n2) at (0.14,-0.0) [regular polygon, regular polygon sides=6, draw=n2draw, fill=n2fill, text=n2text] {};
